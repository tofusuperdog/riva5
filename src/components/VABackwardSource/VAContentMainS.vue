  ...
  if (checkYearPass === 1) {
    alert(
      `Limited data available\n\n` +
        `${inputData.value.exporting.name} - ${inputData.value.importing.name} (source: ${inputData.value.source.name}) is available only for ${yearRangeShow[0]}–${yearRangeShow[1]}.\n` +
